...
import { ChevronRight, Clock as ClockIcon, Share2, Heart, Award, List, Lightbulb } from 'lucide-react';
...
export function GuideDetail({
  ...
  return (
    <div className="min-h-screen">
      <AnalyticsBeacon type="guide_view" entityType="guide" entityId={guide.id} />
      {/* Hero */}
            ...
            <div className="sticky top-24 space-y-6">
              ...
              {guide.author && (
                <div className="p-4 rounded-xl border bg-card">
                  ...
                  <Link href={`/authors/${guide.author.slug}`}>
