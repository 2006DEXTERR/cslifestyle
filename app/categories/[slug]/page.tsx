...
import { categories, products, buyingGuides, comparisons, getProductsByCategory, getGuidesByCategory } from '@/lib/data';
...
export default function CategoryPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const categoryGuides = buyingGuides.filter((g) => g.categorySlug === slug);
